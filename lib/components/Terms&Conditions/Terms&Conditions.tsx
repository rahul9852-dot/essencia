...
const TermsOfService = () => {
  return (
    <div className="min-h-screen bg-[#3b302e] text-[#A6A6A6] pt-20 sm:pt-28 md:pt-32 lg:pt-40 pb-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="space-y-8 sm:space-y-12 md:space-y-16">
          <div>
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#A6A6A6] leading-relaxed">
          ...
          <div className="text-[#A6A6A6] leading-relaxed space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="text-[#A6A6A6] leading-relaxed space-y-3 sm:space-y-4">
              <p className="text-sm sm:text-base md:text-lg">
